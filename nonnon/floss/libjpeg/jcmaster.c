...
LOCAL(void)
jcmaster_initial_setup (j_compress_ptr cinfo, boolean transcode_only)
/* Do computations that are needed before master selection phase */
{
  int ci, ssize;
...
LOCAL(void)
jcmaster_per_scan_setup (j_compress_ptr cinfo)
...
jinit_c_master_control (j_compress_ptr cinfo, boolean transcode_only)
{
  ...
  jcmaster_initial_setup(cinfo, transcode_only);
